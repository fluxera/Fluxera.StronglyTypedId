namespace Fluxera.StronglyTypedId
{
	...
	internal static class Guard
	{
		...
		public static Guid ThrowIfEmpty(Guid argument, [InvokerParameterName][CallerArgumentExpression(nameof(argument))] string parameterName = null)
		{
		...
		public static Guid ThrowIfNullOrEmpty(Guid? argument, [InvokerParameterName][CallerArgumentExpression(nameof(argument))] string parameterName = null)
		{
			ThrowIfNull(argument, parameterName);
			ThrowIfEmpty(argument.Value, parameterName);
		...
		public static T ThrowIfNegativeOrZero<T>(T argument, [InvokerParameterName][CallerArgumentExpression(nameof(argument))] string parameterName = null)
			where T : INumber<T>
		{
		...
		public static double ThrowIfNegativeOrZero(double argument, [InvokerParameterName][CallerArgumentExpression(nameof(argument))] string parameterName = null)
		{
			if(argument <= 0)
			{
				throw new ArgumentException("Value cannot be negative or zero.", parameterName);
